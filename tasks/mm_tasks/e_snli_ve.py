...
from data.mm_data.e_snli_ve_dataset import ESnliVeDataset
...
@register_task("e_snli_ve", dataclass=ESnliVeConfig)
class ESnliVeTask(OFATask):
    def __init__(self, cfg: ESnliVeConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ESnliVeDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
